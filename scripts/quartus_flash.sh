...
DPARAM="${DPARAM} -v ${SRCDIR}/fpga_src:/project -w /project"

# Run Quartus in container
docker run -it --rm ${DPARAM} localhost/quartus bash -c 'quartus_pgm -l && quartus_pgm -m jtag -o "p;qbuild/output_files/haasoscope.sof"'
